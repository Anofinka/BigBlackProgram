...
Shader "beffio/Medieval_Kingdom/SRP/LW/BaseShader"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			float2 _Material_Tiling;
			float4 _Base_color;
			sampler2D _Detail_mask_1_map_input;
			float4 _Detail_mask_1_map_input_ST;
			float _Detail_level;
			float4 _Detail_color;
			sampler2D _Detail_mask_2_map_input;
			float4 _Detail_mask_2_map_input_ST;
			float _Detail_2_level;
			float4 _Detail_2_color;
			...
			sampler2D _Emmisive_mask_map_input;
			float4 _Emmisive_mask_map_input_ST;
			float4 _Emmsivie_color;
			float _Emmisive_intensity;
			sampler2D _Metallic_Smoothness_map_input;
			float _Mettallic_shift;
			float _Material_Smoothness_shift;
			float _Detail_Smoothness_shift;
			sampler2D _Alpha_cutout_mask_map_input;
			float4 _Alpha_cutout_mask_map_input_ST;
			float _Alpha_cutout_level;
			CBUFFER_END
        	...
        	half4 frag (GraphVertexOutput IN ) : SV_Target
            {
				...
				float4 lerpResult46 = lerp( ( saturate( (( blendOpDest12 > 0.5 ) ? ( 1.0 - ( 1.0 - 2.0 * ( blendOpDest12 - 0.5 ) ) * ( 1.0 - blendOpSrc12 ) ) : ( 2.0 * blendOpDest12 * blendOpSrc12 ) ) )) , ( saturate( ( blendOpSrc35 + blendOpDest35 - 1.0 ) )) , temp_output_36_0);
				...
				float4 lerpResult70 = lerp( lerpResult99 , float4(1,1,1,0) , ( tex2D( _Edge_mask_map_input, uv_Edge_mask_map_input ) * _Edge_wear ));
				...
				float4 lerpResult78 = lerp( temp_output_71_0 , float4(0,0,0,0) , ( ( saturate( abs( blendOpSrc80 - blendOpDest80 ) )) * _AO_shift ));
				...
				float3 _normalmap124 = UnpackNormalmapRGorAG( tex2D( _Normal_map_input, _tiling100 ), _Normal_intensity );
				...
				#endif
				float4 temp_cast_3 = (staticSwitch132).xxxx;
				float4 blendOpSrc43 = temp_cast_3;
        ...
        Pass
        {
            ...
            half4 frag(VertexOutput IN) : SV_TARGET
            {
                UNITY_SETUP_INSTANCE_ID(IN);
           		...
           		float2 uv73 = IN.ase_texcoord.xy * _Material_Tiling + float2( 0,0 );
           		float2 _tiling100 = uv73;
           		float4 tex2DNode11 = tex2D( _Albedo_smoothness_map_input, _tiling100 );
           		float4 blendOpSrc12 = tex2DNode11;
           		float4 blendOpDest12 = _Base_color;
           		...
           		float4 blendOpDest35 = _Detail_color;
           		float4 lerpResult46 = lerp( ( saturate( (( blendOpDest12 > 0.5 ) ? ( 1.0 - ( 1.0 - 2.0 * ( blendOpDest12 - 0.5 ) ) * ( 1.0 - blendOpSrc12 ) ) : ( 2.0 * blendOpDest12 * blendOpSrc12 ) ) )) , ( saturate( ( blendOpSrc35 + blendOpDest35 - 1.0 ) )) , temp_output_36_0);
           		float2 uv_Detail_mask_2_map_input = IN.ase_texcoord.xy * _Detail_mask_2_map_input_ST.xy + _Detail_mask_2_map_input_ST.zw;
           		float4 temp_output_97_0 = ( tex2D( _Detail_mask_2_map_input, uv_Detail_mask_2_map_input ) * _Detail_2_level );
           		float4 blendOpSrc98 = temp_output_97_0;
           		float4 blendOpDest98 = _Detail_2_color;
           		float4 lerpResult99 = lerp( lerpResult46 , ( saturate( ( blendOpSrc98 + blendOpDest98 - 1.0 ) )) , temp_output_97_0);
           		...
           		float2 uv_Emmisive_mask_map_input = IN.ase_texcoord.xy * _Emmisive_mask_map_input_ST.xy + _Emmisive_mask_map_input_ST.zw;
           		float4 _emmisive116 = ( ( tex2D( _Emmisive_mask_map_input, uv_Emmisive_mask_map_input ) * _Emmsivie_color ) * _Emmisive_intensity );
...
/*ASEBEGIN
Version=16105
7;1;3426;1370;9129.927;1349.563;1.58172;True;False
...
Node;AmplifyShaderEditor.GetLocalVarNode;101;-9615.265,-1100.868;Float;False;100;_tiling;1;0;OBJECT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ColorNode;4;-9432.391,-1294.665;Float;False;Property;_Base_color;Base_color;1;0;Create;True;0;0;False;0;0.427451,0.227451,0.1372549,0;0.1985294,0.1985294,0.1985294,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;34;-8863.43,-1304.329;Float;False;Property;_Detail_color;Detail_color;2;0;Create;True;0;0;False;0;0,0.9779412,0.7756083,0;0.4307958,0.4617438,0.6102941,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;96;-8173.706,-1312;Float;False;Property;_Detail_2_color;Detail_2_color;4;0;Create;True;0;0;False;0;0,0.9779412,0.7756083,0;0.397221,0.5889483,0.6838235,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;46;-8388.368,-962.2592;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;81;-6720,-1264;Float;False;Constant;_Color0;Color 0;17;0;Create;True;0;0;False;0;1,1,1,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;68;-7480.142,-1308.676;Float;False;Constant;_Color3;Color 3;1;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;119;-6720,-1088;Float;False;118;_AO;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;99;-7677.706,-976;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.LerpOp;70;-7172.663,-1142.538;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;77;-6288,-1264;Float;False;Constant;_Color4;Color 4;1;0;Create;True;0;0;False;0;0,0,0,0;1,1,1,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;86;-7397.535,-660.7678;Float;False;Property;_Emmsivie_color;Emmsivie_color;12;0;Create;True;0;0;False;0;0.9779412,0.9210103,0.6831207,0;0.9779412,0.6892203,0.6831207,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;78;-6240,-1056;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;128;-6528,-384;Float;False;126;_metallic;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;129;-6528,-320;Float;False;127;_smoothness;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;123;-6528,-576;Float;False;122;_albedo;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;117;-6528,-448;Float;False;116;_emmisive;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;115;-6528,-192;Float;False;114;_alpha;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;120;-6528,-256;Float;False;118;_AO;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;103;-8736,-432;Float;False;100;_tiling;1;0;OBJECT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;102;-8608,-80;Float;False;100;_tiling;1;0;OBJECT;0;False;1;FLOAT2;0
...
WireConnection;140;1;125;0
WireConnection;140;2;117;0
WireConnection;140;3;128;0
WireConnection;140;4;129;0
WireConnection;140;5;120;0
WireConnection;140;6;115;0
WireConnection;140;7;138;0
ASEEND*/
//CHKSM=5A8F916CBF0D2311A0A60128BC95015FFFD2FD6A