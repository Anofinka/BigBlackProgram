...
Shader "beffio/Medieval_Kingdom/SRP/LW/Fire"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			float _Vertex_offset_speed;
			float _Vertex_offset_intensity;
			float4 _Base_Texture_ST;
			float4 _BaseColor;
			float4 _Cracksmapcolor;
			sampler2D _Cracks_map;
			float4 _Cracks_map_ST;
			float _Cracksmapintensity;
			float4 _Smallnoisecolor;
			sampler2D _Small_noise_map;
			float _Smallnoiseshift;
			sampler2D _Fire_glow_map;
			float4 _Emmisive_color;
			float _Emmisivemultiply;
			float _Emmisive_Frequency;
			float _Overallermmisiveintensity;
			CBUFFER_END
        	...
        	half4 frag (GraphVertexOutput IN ) : SV_Target
            {
				...
				float4 lerpResult365 = lerp( temp_output_357_0 , _Smallnoisecolor , ( tex2D( _Small_noise_map, _time2480 ) * ( float4(1,1,1,0) * _Smallnoiseshift ) ));
				...
				float4 lerpResult241 = lerp( temp_output_366_0 , float4(1,0.3517241,0,0) , tex2DNode319);
        ...
        Pass
        {
            ...
            half4 frag(VertexOutput IN) : SV_TARGET
            {
                UNITY_SETUP_INSTANCE_ID(IN);
           		...
           		float4 blendOpDest95 = _BaseColor;
           		float4 temp_output_95_0 = ( saturate( ( blendOpSrc95 * blendOpDest95 ) ));
           		float2 uv_Cracks_map = IN.ase_texcoord.xy * _Cracks_map_ST.xy + _Cracks_map_ST.zw;
           		float4 lerpResult356 = lerp( temp_output_95_0 , _Cracksmapcolor , ( tex2D( _Cracks_map, uv_Cracks_map ) * ( float4(1,1,1,0) * _Cracksmapintensity ) ));
           		float4 blendOpSrc357 = temp_output_95_0;
           		float4 blendOpDest357 = lerpResult356;
           		float4 temp_output_357_0 = ( saturate( ( 1.0 - ( 1.0 - blendOpSrc357 ) * ( 1.0 - blendOpDest357 ) ) ));
           		float2 uv476 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
           		float2 panner479 = ( ( _Time.x * 0.01 ) * float2( 0.5,0.5 ) + uv476);
           		float2 _time2480 = panner479;
           		float4 lerpResult365 = lerp( temp_output_357_0 , _Smallnoisecolor , ( tex2D( _Small_noise_map, _time2480 ) * ( float4(1,1,1,0) * _Smallnoiseshift ) ));
           		float4 blendOpSrc366 = temp_output_357_0;
           		float4 blendOpDest366 = lerpResult365;
           		float4 temp_output_366_0 = ( saturate( ( 1.0 - ( 1.0 - blendOpSrc366 ) * ( 1.0 - blendOpDest366 ) ) ));
           		float2 uv313 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
           		float2 panner315 = ( ( _Time.x * 0.02 ) * float2( 0.5,0.5 ) + uv313);
           		float2 _time436 = panner315;
           		float4 tex2DNode319 = tex2D( _Fire_glow_map, _time436 );
           		float4 lerpResult241 = lerp( temp_output_366_0 , float4(1,0.3517241,0,0) , tex2DNode319);
           		...
           		float4 blendOpDest243 = lerpResult241;
           		float4 _fire_color442 = ( saturate( (( blendOpDest243 > 0.5 ) ? ( 1.0 - ( 1.0 - 2.0 * ( blendOpDest243 - 0.5 ) ) * ( 1.0 - blendOpSrc243 ) ) : ( 2.0 * blendOpDest243 * blendOpSrc243 ) ) ));
           		float2 uv486 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
           		float2 panner488 = ( ( _Time.x * _Vertex_offset_speed ) * float2( 0.5,0.5 ) + uv486);
           		float4 _vertex_offset492 = ( tex2D( _Base_Texture, panner488 ) * _Vertex_offset_intensity );
           		float4 blendOpSrc500 = _fire_color442;
           		float4 blendOpDest500 = _vertex_offset492;
...
/*ASEBEGIN
Version=16105
7;1;3426;1370;4312.36;1040.37;2.529352;True;False
...
Node;AmplifyShaderEditor.ColorNode;351;-2112.688,39.8885;Float;False;Constant;_Color2;Color 2;8;0;Create;True;0;0;False;0;1,1,1,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;499;-3073.795,372.2325;Float;True;Property;_Base_Texture;Base_Texture;4;0;Create;True;0;0;False;0;e22a11ad522d7d2488a749b3df99fd58;e22a11ad522d7d2488a749b3df99fd58;False;white;Auto;Texture2D;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.ColorNode;89;-2741.386,-10.51149;Float;False;Property;_BaseColor;Base Color;0;0;Create;True;0;0;False;0;0.1617647,0.1549069,0.1486808,0;0.1617647,0.1549069,0.1486808,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;355;-1840.688,-152.1115;Float;False;Property;_Cracksmapcolor;Cracks map color;5;0;Create;True;0;0;False;0;1,0.3517241,0,0;1,0,0,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;360;-1322.489,69.08853;Float;False;Constant;_Color4;Color 4;8;0;Create;True;0;0;False;0;1,1,1,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;481;-1319.231,-125.5841;Float;False;480;_time2;1;0;OBJECT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ColorNode;375;-1828.103,460.0242;Float;False;Property;_Emmisive_color;Emmisive_color;1;0;Create;True;0;0;False;0;1,0.3529412,0,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;434;-1815.103,726.0244;Float;False;433;_frequency;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;265;-221.3619,-17.14897;Float;False;Constant;_Color1;Color 1;8;0;Create;True;0;0;False;0;1,1,1,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;356;-1802.689,192.8885;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;437;-213.7154,-142.8318;Float;False;436;_time;1;0;OBJECT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ColorNode;364;-799.4886,-123.9115;Float;False;Property;_Smallnoisecolor;Small noise color;10;0;Create;True;0;0;False;0;1,0.3517241,0,0;1,0,0,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;365;-684.4887,140.0885;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;242;541.5891,-13.05411;Float;False;Constant;_Fire_glow_color;Fire_glow_color;10;0;Create;True;0;0;False;0;1,0.3517241,0,0;1,0,0,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;241;560.5889,186.946;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;443;196.3879,1014.326;Float;False;442;_fire_color;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;501;164.3879,1094.326;Float;False;492;_vertex_offset;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;446;420.3879,1142.326;Float;False;445;_emmisive;1;0;OBJECT;0;False;1;COLOR;0
...
WireConnection;510;0;500;0
WireConnection;510;2;446;0
WireConnection;510;4;444;0
WireConnection;510;8;493;0
ASEEND*/
//CHKSM=28AC459B86DA54FFDC84C2508BE5A3372A36E3D6