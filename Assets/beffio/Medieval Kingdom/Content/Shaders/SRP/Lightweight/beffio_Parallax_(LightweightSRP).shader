...
Shader "beffio/Medieval_Kingdom/SRP/LW/Parallax"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			float _Global_Tiling;
			sampler2D _HeightMap;
			float4 _HeightMap_ST;
			float _Parallax;
			sampler2D _Detail_mask;
			float _Detail_mask_level;
			float4 _Detail_mask_color;
			float4 _Detail_mask_2_color;
			sampler2D _Detail_mask_2;
			float _Detail_mask_2_level;
			sampler2D _Occlusion;
			float _Ambient_Occulsion_level;
			float _NormalScale;
			sampler2D _Normal;
        	...
        	half4 frag (GraphVertexOutput IN ) : SV_Target
            {
				...
				float4 lerpResult141 = lerp( ( saturate( (( blendOpDest122 > 0.5 ) ? ( 1.0 - ( 1.0 - 2.0 * ( blendOpDest122 - 0.5 ) ) * ( 1.0 - blendOpSrc122 ) ) : ( 2.0 * blendOpDest122 * blendOpSrc122 ) ) )) , ( saturate( ( blendOpSrc138 * blendOpDest138 ) )) , temp_output_135_0);
				...
				float4 lerpResult130 = lerp( temp_output_144_0 , float4(0,0,0,0) , ( ( saturate( abs( blendOpSrc127 - blendOpDest127 ) )) * _Ambient_Occulsion_level ));
				...
				float3 _normal162 = UnpackNormalmapRGorAG( tex2D( _Normal, _parallax_offset13 ), _NormalScale );
...
/*ASEBEGIN
Version=16105
7;1;3426;1370;6675.244;3056.307;3.208255;True;False
...
Node;AmplifyShaderEditor.GetLocalVarNode;158;-1960.365,-848.3581;Float;False;13;_parallax_offset;1;0;OBJECT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;161;-2311.049,190.125;Float;False;13;_parallax_offset;1;0;OBJECT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;157;-2967.372,-790.6313;Float;False;13;_parallax_offset;1;0;OBJECT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ColorNode;123;-3774.945,-909.4448;Float;False;Property;_Base_Color;Base_Color;1;0;Create;True;0;0;False;0;0.3455882,0.3238225,0.2769788,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;153;-3781.322,-710.0444;Float;False;13;_parallax_offset;1;0;OBJECT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ColorNode;136;-2643.073,-970.2709;Float;False;Property;_Detail_mask_color;Detail_mask_color;2;0;Create;True;0;0;False;0;0.9264706,0,0,0;0.1372547,0.3433941,0.4274508,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;142;-1427.303,-849.3421;Float;False;Property;_Detail_mask_2_color;Detail_mask_2_color;4;0;Create;True;0;0;False;0;0.3466771,0.4411765,0.01297579,0;0.3466771,0.4411765,0.01297579,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;132;-883.6221,-857.5195;Float;False;Constant;_Color1;Color 1;17;0;Create;True;0;0;False;0;1,1,1,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;156;-883.6644,-682.8904;Float;False;154;_AO;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.LerpOp;141;-2206.897,-663.1088;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.LerpOp;143;-1334.845,-671.2673;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;128;-439.4155,-847.8215;Float;False;Constant;_Color0;Color 0;1;0;Create;True;0;0;False;0;0,0,0,0;1,1,1,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;130;-383.7516,-666.5485;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;155;-1376,-32;Float;False;154;_AO;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;165;-1440,-320;Float;False;164;_albedo_blending;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;170;-1408,-128;Float;False;169;_smoothness;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;163;-1376,-224;Float;False;162;_normal;1;0;OBJECT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;159;-2305.769,-110.4992;Float;False;13;_parallax_offset;1;0;OBJECT;0;False;1;FLOAT2;0
...
WireConnection;190;1;163;0
WireConnection;190;4;170;0
WireConnection;190;5;155;0
ASEEND*/
//CHKSM=2BF95A4183F892FC9DEFC849D31CEEF004E623D5